...
function runSubset() {
  ...
  console.warn(
    'Warning: Unable to run fonttools. Install it with `python -m pip install --user fonttools brotli`, or make `pyftsubset` available on PATH. Skipping font subsetting.'
  );
}
